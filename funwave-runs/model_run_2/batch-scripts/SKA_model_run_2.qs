...
#SBATCH --job-name=SKA_model_run_2
#SBATCH --partition=standard
#SBATCH --time=7-00:00:00
#SBATCH --output=./model_run_2/slurm_logs/SKA_out.out
#SBATCH --error=./model_run_2/slurm_logs/SKA_err.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27607923
#
...
## Calculate skew and asymmetry
	run_calc_ska /lustre/scratch/rschanta/ model_run_2 /work/thsu/rschanta/RTS/
