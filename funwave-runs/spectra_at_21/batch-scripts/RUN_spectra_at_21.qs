...
#SBATCH --output=/work/thsu/rschanta/RTS/funwave-runs/spectra_at_21/slurm_logs/RUN_out_%a.out
#SBATCH --error=/work/thsu/rschanta/RTS/funwave-runs/spectra_at_21/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27912157
#SBATCH --array=1-10
#
