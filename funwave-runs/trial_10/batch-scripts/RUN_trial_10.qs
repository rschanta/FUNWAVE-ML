...
#SBATCH --job-name=RUN_trial_10
#SBATCH --partition=thsu
#SBATCH --time=7-00:00:00
#SBATCH --output=./trial_10/slurm_logs/RUN_out_%a.out
#SBATCH --error=./trial_10/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterok:27592990
#SBATCH --array=1-4
#
...
## Get input file name
	input_file=$(get_input_dir "/lustre/scratch/rschanta/" "trial_10" "$SLURM_ARRAY_TASK_ID")

## Run FUNWAVE
	${UD_MPIRUN} "$fun_ex" "$input_file"

## Compress outputs from run to single structure
	run_compress_out_i /lustre/scratch/rschanta/ trial_10 "$SLURM_ARRAY_TASK_ID"

#rm -rf "/lustre/scratch/rschanta/trial_10/outputs-raw/out_$(printf "%05d" $SLURM_ARRAY_TASK_ID)/"
