...
#SBATCH --job-name=GEN_trial_10
#SBATCH --partition=thsu
#SBATCH --time=7-00:00:00
#SBATCH --output=./trial_10/slurm_logs/GEN_out.out
#SBATCH --error=./trial_10/slurm_logs/GEN_err.out
...
## Run Generation Script
	run_MATLAB_script "./trial_10/trial_10.m"
