...
#SBATCH --job-name=COMP_trial_10
#SBATCH --partition=thsu
#SBATCH --time=7-00:00:00
#SBATCH --output=./trial_10/slurm_logs/COMP_out.out
#SBATCH --error=./trial_10/slurm_logs/COMP_err.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterok:27592991
#
...
## Compress outputs from all runs to a single structure
	args="'/lustre/scratch/rschanta/','trial_10'"
	run_compress_out $args

## Keep for now
	#rm -rf "/lustre/scratch/rschanta/trial_10/outputs-proc/"
	rm -rf "/lustre/scratch/rschanta/trial_10/outputs-raw/"
