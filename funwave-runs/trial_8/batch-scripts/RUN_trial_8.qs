...
#SBATCH --job-name=RUN_trial_8
#SBATCH --partition=thsu
#SBATCH --time=7-00:00:00
#SBATCH --output=./trial_8/slurm_logs/RUN_out_%a.out
#SBATCH --error=./trial_8/slurm_logs/RUN_err_%a.out
...
## Compress outputs from run to single structure
	run_compress_out_i /lustre/scratch/rschanta/ trial_8 "$SLURM_ARRAY_TASK_ID"

#rm -rf "/lustre/scratch/rschanta/trial_8/outputs-raw/out_$(printf "%05d" $SLURM_ARRAY_TASK_ID)/"
