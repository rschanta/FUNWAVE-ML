...
#SBATCH --job-name=SKA_model_run_4
#SBATCH --partition=standard
#SBATCH --time=7-00:00:00
#SBATCH --output=./model_run_4/slurm_logs/SKA_out.out
#SBATCH --error=./model_run_4/slurm_logs/SKA_err.out
...
## Calculate skew and asymmetry
	run_comp_ska /lustre/scratch/rschanta/ model_run_4 /work/thsu/rschanta/RTS/
