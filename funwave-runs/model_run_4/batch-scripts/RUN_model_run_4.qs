...
#SBATCH --job-name=RUN_model_run_4
#SBATCH --partition=standard
#SBATCH --time=7-00:00:00
#SBATCH --output=./model_run_4/slurm_logs/RUN_out_%a.out
#SBATCH --error=./model_run_4/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27624388
#SBATCH --array=1-4000
#
...
## Get input file name
	input_file=$(get_input_dir "/lustre/scratch/rschanta/" "model_run_4" "$SLURM_ARRAY_TASK_ID")

## Run FUNWAVE
	${UD_MPIRUN} "$fun_ex" "$input_file"

## Compress outputs from run to single structure
	run_compress_out_ska_i /lustre/scratch/rschanta/ model_run_4 "$SLURM_ARRAY_TASK_ID" "/work/thsu/rschanta/RTS/"
