...
#SBATCH --output=/work/thsu/rschanta/RTS/funwave-runs/Spectra_D3_1/slurm_logs/RUN_out_%a.out
#SBATCH --error=/work/thsu/rschanta/RTS/funwave-runs/Spectra_D3_1/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27894875
#SBATCH --array=1-2
#
...
#
		## Load in bash functions and VALET packages
			...
			export_vars "/lustre/scratch/rschanta/" "/work/thsu/rschanta/RTS/" "Spectra_D3_1" "rschanta@udel.edu"
