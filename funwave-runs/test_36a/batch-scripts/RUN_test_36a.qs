...
#SBATCH --output=/work/thsu/rschanta/RTS/funwave-runs/test_36a/slurm_logs/RUN_out_%a.out
#SBATCH --error=/work/thsu/rschanta/RTS/funwave-runs/test_36a/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27895262
#SBATCH --array=1-2
#
...
#
		## Load in bash functions and VALET packages
			...
			export_vars "/lustre/scratch/rschanta/" "/work/thsu/rschanta/RTS/" "test_36a" "rschanta@udel.edu"
