...
#SBATCH --output=/work/thsu/rschanta/RTS/funwave-runs/test_37/slurm_logs/RUN_out_%a.out
#SBATCH --error=/work/thsu/rschanta/RTS/funwave-runs/test_37/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27896062
#SBATCH --array=1-2
#
...
#
		## Load in bash functions and VALET packages
			...
			export_vars "/lustre/scratch/rschanta/" "/work/thsu/rschanta/RTS/" "test_37" "rschanta@udel.edu"
			vpkg_require openmpi
			vpkg_require matlab
		## Get input file name
			input_file=$(get_input_dir "$SLURM_ARRAY_TASK_ID")
		## Run FUNWAVE
			${UD_MPIRUN} "/work/thsu/rschanta/RTS/funwave/v3.7/exec/FW-REG" "$input_file"
