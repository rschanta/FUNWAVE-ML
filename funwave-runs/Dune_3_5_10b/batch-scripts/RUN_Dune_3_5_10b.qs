...
#SBATCH --job-name=RUN_Dune_3_5_10b
#SBATCH --partition=standard
#SBATCH --time=7-00:00:00
#SBATCH --output=./Dune_3_5_10b/slurm_logs/RUN_out_%a.out
#SBATCH --error=./Dune_3_5_10b/slurm_logs/RUN_err_%a.out
#SBATCH --mail-user=rschanta@udel.edu
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --export=ALL
#SBATCH --dependency=afterany:27624299
#SBATCH --array=1-2
#
...
## Get input file name
	input_file=$(get_input_dir "/lustre/scratch/rschanta/" "Dune_3_5_10b" "$SLURM_ARRAY_TASK_ID")

## Run FUNWAVE
	${UD_MPIRUN} "$fun_ex" "$input_file"

## Compress outputs from run to single structure
	run_compress_out_ska_i /lustre/scratch/rschanta/ Dune_3_5_10b "$SLURM_ARRAY_TASK_ID" "/work/thsu/rschanta/RTS/"
